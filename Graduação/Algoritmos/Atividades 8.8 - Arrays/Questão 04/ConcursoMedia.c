...
Sabe-se que são 1000 candidatos e que a pontuação necessária para classificação deve ser maior ou igual a
média das pontuações considerando todos os candidatos.*/
